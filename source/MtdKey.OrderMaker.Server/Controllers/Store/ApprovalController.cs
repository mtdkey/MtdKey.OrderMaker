...
namespace MtdKey.OrderMaker.Controllers.Store
{
    ...
    public class ApprovalController(OrderMakerContext context, UserHandler userHandler, IEmailSenderBlank emailSender, IStringLocalizer<SharedResource> sharedLocalizer) : ControllerBase
    {
