    ...
    public class Startup(IConfiguration configuration, IWebHostEnvironment env)
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<IdentityDbContext>(options =>
                options.UseMySql(orderMakerIdentity, ServerVersion.AutoDetect(orderMakerIdentity), mysqlOptions => {
            ...
            services.AddDbContext<OrderMakerContext>(options =>
                options.UseMySql(orderMakerData, ServerVersion.AutoDetect(orderMakerData), mysqlOptions => {
                    mysqlOptions.EnableRetryOnFailure(
                        maxRetryCount: 5,
                        maxRetryDelay: TimeSpan.FromSeconds(10),
                        errorNumbersToAdd: null);
            ...
            services.AddScoped<OrderMakerContext>();
